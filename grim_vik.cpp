...
// input plugs
	iStretchBlend = nAttr.create("stretchBlend", "stretchBlend", MFnNumericData::kDouble, 1.0f);
	...
	iFkIkBlend = nAttr.create("fkIkBlend", "fkIkBlend", MFnNumericData::kDouble, 1.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iElbowPinBlend = nAttr.create("elbowPinBlend", "elbowPinBlend", MFnNumericData::kDouble, 0.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iReverseBlend = nAttr.create("reverseBlend", "reverseBlend", MFnNumericData::kDouble, 0.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iOrientTipBlend = nAttr.create("orientTipBlend", "orientTipBlend", MFnNumericData::kDouble, 1.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iUpperLength = nAttr.create("upperLength", "upperLength", MFnNumericData::kDouble, -1.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iLowerLength = nAttr.create("lowerLength", "lowerLength", MFnNumericData::kDouble, -1.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iUpperLengthBoost = nAttr.create("upperLengthBoost", "upperLengthBoost", MFnNumericData::kDouble, 100.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iLowerLengthBoost = nAttr.create("lowerLengthBoost", "lowerLengthBoost", MFnNumericData::kDouble, 100.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iLengthBoost = nAttr.create("lengthBoost", "lengthBoost", MFnNumericData::kDouble, 100.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iSoftness = nAttr.create("softness", "softness", MFnNumericData::kDouble, 0.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
	...
	iTwist = nAttr.create("twist", "twist", MFnNumericData::kDouble, 0.0f);
		nAttr.setStorable(true);
		nAttr.setKeyable(true);
		nAttr.setReadable(true);
		nAttr.setWritable(true);
